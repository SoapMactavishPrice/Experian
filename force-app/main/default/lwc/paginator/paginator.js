...
export default class Paginator extends LightningElement {
    ...
    connectedCallback() {
      ...
      //   JSON.parse(JSON.stringify(this.pageSizeOptions))
      // );
      if (this.pageSizeOptions && this.pageSizeOptions.length > 0) {
        this.pageSize = this.pageSizeOptions[0];
        // console.log(
        //   "IF pageSizeOptions => ",
        //   JSON.parse(JSON.stringify(this.pageSize))
        // );
      } else {
      ...
      console.log("Ha 01:>>", this.controlPagination);
    ...
    setRecordsToDisplay() {
      ...
      // console.log("HA 02 totalRecords =>", JSON.parse(JSON.stringify(this.totalRecords)));
  
      this.totalPages = Math.ceil(this.totalRecords / this.pageSize);
      // console.log(
      //   "THIS DISPATCH EVENTS totalPages =>",
      //   JSON.parse(JSON.stringify(this.totalPages))
      // );
      ...
      // console.log("HA 03 this.recordsToDisplay::>", this.recordsToDisplay);
      ...
      if (searchKey) {
        this.delayTimeout = setTimeout(() => {
          ...
          if (
            ...
            //   console.log("THIS DISPATCH EVENTS HANDLE KEY CHANGE");
          ...
          // console.log(
          //   "THIS DISPATCH EVENTS THIS DISPATCH EVENTS HANDLE KEY CHANGE"
          // );
        }, DELAY);
      } else {
