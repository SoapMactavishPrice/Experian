trigger UpdateCaseFromIO on IO_Comments__c (after insert) {
    ...
    Map<Id, Case> caseMap = new Map<Id, Case>([
        SELECT Id, Re_Referred_To_IO_Count__c, IO_Comments__c, Dispute_Rejected_Reason__c, IO_Status__c, 
    ...
    for (IO_Comments__c io : Trigger.new) {
        if (caseMap.containsKey(io.Case__c)) {
            ...
            if (io.Status__c == 'Seeking Further Information - Member') { 
                ...
                parentCase.Seeking_Further_Information_Consumer__c  = true;
                ...
                parentCase.Seeking_Further_Information_DRU_to_check__c = true;
                parentCase.SFI_DRU_to_check_Date__c = system.today();
            }    
